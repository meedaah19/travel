...
export default function Content(){
    return(
        <main>
            <div className="pt-[25px] p-[100px] pb-[25px] w-[1280px] ">
                    <h1 className="font-[didot] font-[700] text-5xl  text-[#000000] tracking-normal ">Find An <br /> Experience</h1>
                    ...
                    <div className="pt-4 flex text-left gap-7">
